    ...
    <div class="container containerForm">
        ...
        <form id="formDonacion" autocomplete="off" method="POST" action="{{route('donaciones.update',$donaciones['id'])}} " enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name_donante" placeholder="Ingrese nombre" class="form-control" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" value={{ $donaciones->name_donante }} />
            </div>
